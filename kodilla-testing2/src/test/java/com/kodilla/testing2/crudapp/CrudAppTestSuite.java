...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://katarzynanabozny.github.io/";
    ...
    public void removeCrudAppTask(String taskName) throws InterruptedException {
        final String XPATH_DELETE = ".//button[@data-task-delete-button=\"\"]";
        ...
        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                ...
                .forEach(button -> {
                    WebElement buttonDelete = button.findElement(By.xpath(XPATH_DELETE));
                    buttonDelete.click();
                });
